...
public class Solution {
    ...
    public static void main(String[] args) {
        ListNode head1 = ListNode.geNerateLinkedList(Arrays.asList(1, 1));
        ListNode head2 = ListNode.geNerateLinkedList(Arrays.asList(1, 1, 2, 3, 3));
        ListNode head3 = ListNode.geNerateLinkedList(Arrays.asList(1));
        ListNode head4 = ListNode.geNerateLinkedList(Arrays.asList(1, 3));
        ListNode head5 = ListNode.geNerateLinkedList(Arrays.asList(1, 3, 3));
